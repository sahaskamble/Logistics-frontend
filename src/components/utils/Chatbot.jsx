...
export default function ChatBot() {
	...
	const getRepresentativeHandoffMessage = () => {
		if (user) {
			return "I've noticed we've been chatting for a while! 😊 To provide you with the best possible assistance, I'd like to connect you with one of our human representatives.\n\n" +
				"🔄 **Starting live chat session...**\n" +
				"Please wait while I connect you with a support representative who can offer more personalized help.\n\n" +
				"💡 **Alternative:** You can also visit our [Support Center](/support) to start a new chat or view your existing conversations.\n\n" +
			...
			return "I've noticed we've been chatting for a while! 😊 To provide you with the best possible assistance, I'd like to connect you with one of our human representatives.\n\n" +
				...
				"💡 **Tip:** Log in and visit our [Support Center](/support) to start a live chat session with our support team!\n\n" +
			...
			if (session) {
				...
				const transitionMessage = {
					...
					text: '✅ **Live chat session created successfully!**\n\n' +
						  'You are now connected to our support team. A representative will be with you shortly.\n\n' +
						  `**Session ID:** ${session.id}\n\n` +
						  'This chatbot conversation will remain here for your reference. Your live chat will open in a new window.',
					timestamp: Date.now()
				};

				setMessages(prev => [...prev, transitionMessage]);

				// Open the live chat in a new window/tab (you can customize this)
				const chatUrl = `/support/chat/${session.id}`;
				window.open(chatUrl, '_blank', 'width=400,height=600,scrollbars=yes,resizable=yes');

				toast.success('Live chat session started! Check the new window.');
			}
		} catch (error) {
		...
		if (text.includes('human') || text.includes('agent') || text.includes('person') || text.includes('representative')) {
			...
			if (user) {
				return "I'll connect you with a human representative right away! 🔄\n\n" +
					"Starting a live chat session for you. Please wait a moment while I set this up...\n\n" +
					"💡 A new window will open with your live chat session.";
			} else {
				return "I'll connect you with a human representative right away! Here are the ways to reach our team:\n\n" +
					"📞 **Phone:** +91-1234567890\n" +
					"📧 **Email:** support@greenoceanlogistics.com\n" +
					"💬 **WhatsApp:** +91-9876543210\n\n" +
					"💡 **Tip:** Log in to start a live chat session with our support team!\n\n" +
