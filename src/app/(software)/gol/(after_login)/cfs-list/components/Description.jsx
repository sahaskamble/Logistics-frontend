          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex items-center border p-3 rounded-md bg-background">
              ...
              <div>
                ...
                <div className="text-sm font-medium text-gray-800">{capacity || 'Not specified'}</div>
              </div>
            </div>
            <div className="flex items-center border p-3 rounded-md bg-background">
              ...
              <div>
                ...
                <div className="text-sm font-medium text-gray-800">{operatingHours || 'Not specified'}</div>
              </div>
            </div>
            <div className="flex items-center border p-3 rounded-md bg-background">
              ...
              <div>
                ...
                <div className="text-sm font-medium text-gray-800">{cfsCode || 'Not specified'}</div>
              </div>
            </div>
            <div className="flex items-center border p-3 rounded-md bg-[#D4E6D2]">
              ...
              <div>
                ...
                {registeredDate ? new Date(registeredDate).toLocaleDateString('en-US', {
                  year: 'numeric',
                  month: 'short'
                }) : 'Not specified'}
              </div>
