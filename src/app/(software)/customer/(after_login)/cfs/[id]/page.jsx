    ...
    <div className="max-w-container mx-auto px-6 py-10 space-y-8 bg-[color:var(--accent)] rounded-lg shadow-lg">
      ...
      */}
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <DetailCard label="Description" value={order.orderDescription} full />
      </section>
      ...
      <section>
        ...
        {order.expand?.cfs ? (
          <div className="bg-[color:var(--background-2)] p-5 rounded-md shadow-sm border border-[color:var(--primary)] space-y-2">
            <DetailCard label="Title" value={order.expand.cfs.title} />
            <DetailCard label="Location" value={order.expand.cfs.location} />
            <DetailCard label="Contact" value={order.expand.cfs.contact} />
          </div>
        ) : (
...
export function DetailCard({ label, value, full = false, color = 'foreground', status = false }) {
