...
export default function EIRCopyDetailsPage() {
  ...
  useEffect(() => {
    setTitle('View EIR Copy Details');
  ...
  if (!detail) return <div className="p-8 text-red-600 text-center">EIR Record not found.</div>;
  ...
  return (
    <div className="max-w-container mx-auto px-6 py-10 space-y-8 bg-[color:var(--accent)] rounded-lg shadow-lg">
      <header className="border-b border-[color:var(--secondary)] pb-4 mb-6 space-y-2">
        <AppBreadcrumb />
        <h1 className="text-3xl font-bold text-[color:var(--foreground)]">EIR Copy Details</h1>
