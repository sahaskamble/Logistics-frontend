          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-gray-600">Connect with our support team instantly</p>
                </div>
            ...
            <div className="bg-white rounded-lg shadow">
              <div className="p-6 border-b">
                <h2 className="text-lg font-semibold text-gray-900">Your Chat Sessions</h2>
                <p className="text-gray-600">View and continue your previous conversations</p>
              </div>
